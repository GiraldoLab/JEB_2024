#!/usr/bin/env python
# For fig3 data analysis - Plots Sun1 and Sun2 headings as a linear plot, plots heading difference as a polar plot and reshuffled distribution(bootstrap analysis)
# Use to run each intertrial group (1hr interval, 2hr interval, 6hr interval, 8hr interval)
...
path = '' #Path for fig3 data. For each intertrial group folder(1hr interval, 2hr interval, 6hr interval, 8hr interval)
...
PlotSeaUrchin(rotated_heading_anglesA, allFliesVecStrengthCutOffA, 'Sun1 headings polar plot')
PlotSeaUrchin(rotated_heading_anglesB, allFliesVecStrengthCutOffB, 'Sun2 headings polar plot')
